      ...
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <div class="contact-us-content">
            <form id="contact-form" action="register_process.php" method="post">
              <div class="row">
                <div class="col-lg-12">
                  <fieldset>
                ...
                <div class="col-lg-12">
                  <fieldset class="password-field">
                    <input type="password" name="password" id="password" placeholder="Ulangi Kata Sandi" autocomplete="on" required>
                  </fieldset>
                </div>
